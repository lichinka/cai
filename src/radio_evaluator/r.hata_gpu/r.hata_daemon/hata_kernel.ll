...
define void @__OpenCL_agent_kern_kernel(i32 %ntx, i32 %ncols, <4 x i32> %mdim, i32 %uncovered_count, i8 addrspace(1)* %pl_in, <4 x i32> addrspace(1)* %offsets_in, float addrspace(1)* %qrm_in, float addrspace(1)* %cov_in, i16 addrspace(1)* %uncov_coord_in, i32 addrspace(1)* %tx_pwr, i16 addrspace(3)* %pblock) nounwind {
entry:
  ...
  %uncovered_count.addr = alloca i32, align 4     ; <i32*> [#uses=3]
  %pl_in.addr = alloca i8 addrspace(1)*, align 4  ; <i8 addrspace(1)**> [#uses=3]
  %offsets_in.addr = alloca <4 x i32> addrspace(1)*, align 4 ; <<4 x i32> addrspace(1)**> [#uses=7]
  ...
  %tx_pwr.addr = alloca i32 addrspace(1)*, align 4 ; <i32 addrspace(1)**> [#uses=6]
  %pblock.addr = alloca i16 addrspace(3)*, align 4 ; <i16 addrspace(3)**> [#uses=7]
  %tx = alloca i32, align 4                       ; <i32*> [#uses=18]
  %randstate = alloca %1, align 8                 ; <%1*> [#uses=4]
  %idx_thread = alloca i32, align 4               ; <i32*> [#uses=9]
  %tmp = alloca <2 x i32>, align 8                ; <<2 x i32>*> [#uses=2]
  %ccoord = alloca <2 x i32>, align 8             ; <<2 x i32>*> [#uses=22]
  %idx_coord = alloca i32, align 4                ; <i32*> [#uses=3]
  %idx_2d = alloca i32, align 4                   ; <i32*> [#uses=4]
  %tmp85 = alloca <2 x float>, align 8            ; <<2 x float>*> [#uses=2]
  %max_signal = alloca <2 x float>, align 8       ; <<2 x float>*> [#uses=7]
  %idx_pl = alloca i32, align 4                   ; <i32*> [#uses=4]
  %pl_value = alloca float, align 4               ; <float*> [#uses=9]
  %tx_id = alloca i32, align 4                    ; <i32*> [#uses=3]
  %tx_new_pwr = alloca float, align 4             ; <float*> [#uses=4]
  %tmp178 = alloca <2 x float>, align 8           ; <<2 x float>*> [#uses=2]
  %min_signal = alloca <2 x float>, align 8       ; <<2 x float>*> [#uses=7]
  %idx_pl187 = alloca i32, align 4                ; <i32*> [#uses=4]
  %pl_value212 = alloca float, align 4            ; <float*> [#uses=9]
  %tx_id253 = alloca i32, align 4                 ; <i32*> [#uses=3]
  %tx_new_pwr257 = alloca float, align 4          ; <float*> [#uses=4]
  %idx_local = alloca i32, align 4                ; <i32*> [#uses=2]
...
if.end7:                                          ; preds = %if.then8, %if.then
  br label %if.end

if.then8:                                         ; preds = %if.then
  %call9 = call i64 @random(%1* %randstate) nounwind ; <i64> [#uses=1]
  %tmp10 = load i32* %uncovered_count.addr        ; <i32> [#uses=1]
  %conv11 = sext i32 %tmp10 to i64                ; <i64> [#uses=1]
  %tmp12 = urem i64 %call9, %conv11               ; <i64> [#uses=1]
  %conv13 = trunc i64 %tmp12 to i32               ; <i32> [#uses=1]
  store i32 %conv13, i32* %idx_coord
  %tmp14 = load i16 addrspace(1)** %uncov_coord_in.addr ; <i16 addrspace(1)*> [#uses=1]
  %tmp15 = load i32* %idx_coord                   ; <i32> [#uses=1]
  %tmp16 = mul i32 2, %tmp15                      ; <i32> [#uses=1]
  %arrayidx = getelementptr i16 addrspace(1)* %tmp14, i32 %tmp16 ; <i16 addrspace(1)*> [#uses=1]
  %tmp17 = load i16 addrspace(1)* %arrayidx       ; <i16> [#uses=1]
  %conv18 = zext i16 %tmp17 to i32                ; <i32> [#uses=1]
  %tmp19 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp20 = insertelement <2 x i32> %tmp19, i32 %conv18, i32 0 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp20, <2 x i32>* %ccoord
  %tmp21 = load i16 addrspace(1)** %uncov_coord_in.addr ; <i16 addrspace(1)*> [#uses=1]
  %tmp22 = load i32* %idx_coord                   ; <i32> [#uses=1]
  %tmp23 = mul i32 2, %tmp22                      ; <i32> [#uses=1]
  %tmp24 = add nsw i32 %tmp23, 1                  ; <i32> [#uses=1]
  %arrayidx25 = getelementptr i16 addrspace(1)* %tmp21, i32 %tmp24 ; <i16 addrspace(1)*> [#uses=1]
  ...
  %tmp29 = insertelement <2 x i32> %tmp28, i32 %conv27, i32 1 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp29, <2 x i32>* %ccoord
  br label %if.end7

if.end33:                                         ; preds = %if.then34, %if.end
  %tmp71 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp72 = extractelement <2 x i32> %tmp71, i32 1 ; <i32> [#uses=1]
  %tmp73 = load i32* %ncols.addr                  ; <i32> [#uses=1]
  %tmp74 = mul i32 %tmp72, %tmp73                 ; <i32> [#uses=1]
  %tmp75 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp76 = extractelement <2 x i32> %tmp75, i32 0 ; <i32> [#uses=1]
  %tmp77 = add nsw i32 %tmp74, %tmp76             ; <i32> [#uses=1]
  store i32 %tmp77, i32* %idx_2d
  %tmp78 = load float addrspace(1)** %cov_in.addr ; <float addrspace(1)*> [#uses=1]
  %tmp79 = load i32* %idx_2d                      ; <i32> [#uses=1]
  ...
  %cmp82 = fcmp olt float %tmp81, 0x3F847AE140000000 ; <i1> [#uses=1]
  br i1 %cmp82, label %if.then84, label %if.else

if.then34:                                        ; preds = %if.end
  %call35 = call i64 @random(%1* %randstate) nounwind ; <i64> [#uses=1]
  %tmp36 = load <4 x i32>* %mdim.addr             ; <<4 x i32>> [#uses=1]
  %tmp37 = extractelement <4 x i32> %tmp36, i32 2 ; <i32> [#uses=1]
  %tmp38 = load <4 x i32>* %mdim.addr             ; <<4 x i32>> [#uses=1]
  %tmp39 = extractelement <4 x i32> %tmp38, i32 0 ; <i32> [#uses=1]
  %tmp40 = sub nsw i32 %tmp37, %tmp39             ; <i32> [#uses=1]
  %conv41 = sext i32 %tmp40 to i64                ; <i64> [#uses=1]
  %tmp42 = urem i64 %call35, %conv41              ; <i64> [#uses=1]
  %conv43 = trunc i64 %tmp42 to i32               ; <i32> [#uses=1]
  %tmp44 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp45 = insertelement <2 x i32> %tmp44, i32 %conv43, i32 0 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp45, <2 x i32>* %ccoord
  %tmp46 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp47 = extractelement <2 x i32> %tmp46, i32 0 ; <i32> [#uses=1]
  %tmp48 = load <4 x i32>* %mdim.addr             ; <<4 x i32>> [#uses=1]
  %tmp49 = extractelement <4 x i32> %tmp48, i32 0 ; <i32> [#uses=1]
  %tmp50 = add nsw i32 %tmp47, %tmp49             ; <i32> [#uses=1]
  %tmp51 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp52 = insertelement <2 x i32> %tmp51, i32 %tmp50, i32 0 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp52, <2 x i32>* %ccoord
  %call53 = call i64 @random(%1* %randstate) nounwind ; <i64> [#uses=1]
  %tmp54 = load <4 x i32>* %mdim.addr             ; <<4 x i32>> [#uses=1]
  %tmp55 = extractelement <4 x i32> %tmp54, i32 3 ; <i32> [#uses=1]
  %tmp56 = load <4 x i32>* %mdim.addr             ; <<4 x i32>> [#uses=1]
  %tmp57 = extractelement <4 x i32> %tmp56, i32 1 ; <i32> [#uses=1]
  %tmp58 = sub nsw i32 %tmp55, %tmp57             ; <i32> [#uses=1]
  %conv59 = sext i32 %tmp58 to i64                ; <i64> [#uses=1]
  %tmp60 = urem i64 %call53, %conv59              ; <i64> [#uses=1]
  %conv61 = trunc i64 %tmp60 to i32               ; <i32> [#uses=1]
  %tmp62 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp63 = insertelement <2 x i32> %tmp62, i32 %conv61, i32 1 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp63, <2 x i32>* %ccoord
  %tmp64 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp65 = extractelement <2 x i32> %tmp64, i32 1 ; <i32> [#uses=1]
  %tmp66 = load <4 x i32>* %mdim.addr             ; <<4 x i32>> [#uses=1]
  %tmp67 = extractelement <4 x i32> %tmp66, i32 1 ; <i32> [#uses=1]
  %tmp68 = add nsw i32 %tmp65, %tmp67             ; <i32> [#uses=1]
  %tmp69 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp70 = insertelement <2 x i32> %tmp69, i32 %tmp68, i32 1 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp70, <2 x i32>* %ccoord
  br label %if.end33

if.end83:                                         ; preds = %for.exit181, %for.exit
  call void @barrier(i32 0, i32 1) nounwind
  %tmp279 = load i16 addrspace(3)** %pblock.addr  ; <i16 addrspace(3)*> [#uses=1]
  %tmp280 = load i32* %idx_thread                 ; <i32> [#uses=1]
  %tmp281 = mul i32 2, %tmp280                    ; <i32> [#uses=1]
  %arrayidx282 = getelementptr i16 addrspace(3)* %tmp279, i32 %tmp281 ; <i16 addrspace(3)*> [#uses=1]
  %tmp283 = load i16 addrspace(3)* %arrayidx282   ; <i16> [#uses=1]
  %conv284 = zext i16 %tmp283 to i32              ; <i32> [#uses=1]
  store i32 %conv284, i32* %idx_local
  %tmp285 = load i32 addrspace(1)** %tx_pwr.addr  ; <i32 addrspace(1)*> [#uses=1]
  %tmp286 = load i32* %idx_local                  ; <i32> [#uses=1]
  %arrayidx287 = getelementptr i32 addrspace(1)* %tmp285, i32 %tmp286 ; <i32 addrspace(1)*> [#uses=1]
  %tmp288 = load i16 addrspace(3)** %pblock.addr  ; <i16 addrspace(3)*> [#uses=1]
  %tmp289 = load i32* %idx_thread                 ; <i32> [#uses=1]
  %tmp290 = mul i32 2, %tmp289                    ; <i32> [#uses=1]
  %tmp291 = add nsw i32 %tmp290, 1                ; <i32> [#uses=1]
  %arrayidx292 = getelementptr i16 addrspace(3)* %tmp288, i32 %tmp291 ; <i16 addrspace(3)*> [#uses=1]
  %tmp293 = load i16 addrspace(3)* %arrayidx292   ; <i16> [#uses=1]
  %conv294 = zext i16 %tmp293 to i32              ; <i32> [#uses=1]
  store i32 %conv294, i32 addrspace(1)* %arrayidx287
  br label %return

if.then84:                                        ; preds = %if.end33
  store <2 x float> <float -1.000000e+00, float 0xC0C387F340000000>, <2 x float>* %tmp85
  %tmp86 = load <2 x float>* %tmp85               ; <<2 x float>> [#uses=1]
  store <2 x float> %tmp86, <2 x float>* %max_signal
  store i32 0, i32* %tx
  br label %for.cond

if.else:                                          ; preds = %if.end33
  store <2 x float> <float -1.000000e+00, float 0x40C387F340000000>, <2 x float>* %tmp178
  %tmp179 = load <2 x float>* %tmp178             ; <<2 x float>> [#uses=1]
  store <2 x float> %tmp179, <2 x float>* %min_signal
  store i32 0, i32* %tx
  br label %for.cond180

for.cond:                                         ; preds = %for.inc, %if.then84
  %tmp87 = load i32* %tx                          ; <i32> [#uses=1]
  %tmp88 = load i32* %ntx.addr                    ; <i32> [#uses=1]
  %cmp89 = icmp slt i32 %tmp87, %tmp88            ; <i1> [#uses=1]
  br i1 %cmp89, label %for.body, label %for.exit

for.exit:                                         ; preds = %for.cond
  %tmp154 = load <2 x float>* %max_signal         ; <<2 x float>> [#uses=1]
  %tmp155 = extractelement <2 x float> %tmp154, i32 0 ; <float> [#uses=1]
  %conv156 = fptosi float %tmp155 to i32          ; <i32> [#uses=1]
  store i32 %conv156, i32* %tx_id
  store float 0x3FB99999A0000000, float* %tx_new_pwr
  %tmp157 = load float* %tx_new_pwr               ; <float> [#uses=1]
  %call158 = call float @__pow_f32(float 1.000000e+01, float %tmp157) nounwind ; <float> [#uses=1]
  store float %call158, float* %tx_new_pwr
  %tmp159 = load i16 addrspace(3)** %pblock.addr  ; <i16 addrspace(3)*> [#uses=1]
  %tmp160 = load i32* %idx_thread                 ; <i32> [#uses=1]
  %tmp161 = mul i32 2, %tmp160                    ; <i32> [#uses=1]
  %arrayidx162 = getelementptr i16 addrspace(3)* %tmp159, i32 %tmp161 ; <i16 addrspace(3)*> [#uses=1]
  %tmp163 = load i32* %tx_id                      ; <i32> [#uses=1]
  %conv164 = trunc i32 %tmp163 to i16             ; <i16> [#uses=1]
  store i16 %conv164, i16 addrspace(3)* %arrayidx162
  %tmp165 = load i16 addrspace(3)** %pblock.addr  ; <i16 addrspace(3)*> [#uses=1]
  %tmp166 = load i32* %idx_thread                 ; <i32> [#uses=1]
  %tmp167 = mul i32 2, %tmp166                    ; <i32> [#uses=1]
  %tmp168 = add nsw i32 %tmp167, 1                ; <i32> [#uses=1]
  %arrayidx169 = getelementptr i16 addrspace(3)* %tmp165, i32 %tmp168 ; <i16 addrspace(3)*> [#uses=1]
  %tmp170 = load float* %tx_new_pwr               ; <float> [#uses=1]
  %tmp171 = load i32 addrspace(1)** %tx_pwr.addr  ; <i32 addrspace(1)*> [#uses=1]
  %tmp172 = load i32* %tx_id                      ; <i32> [#uses=1]
  %arrayidx173 = getelementptr i32 addrspace(1)* %tmp171, i32 %tmp172 ; <i32 addrspace(1)*> [#uses=1]
  %tmp174 = load i32 addrspace(1)* %arrayidx173   ; <i32> [#uses=1]
  %conv175 = sitofp i32 %tmp174 to float          ; <float> [#uses=1]
  %tmp176 = fmul float %tmp170, %conv175          ; <float> [#uses=1]
  %conv177 = fptoui float %tmp176 to i16          ; <i16> [#uses=1]
  store i16 %conv177, i16 addrspace(3)* %arrayidx169
  br label %if.end83

for.body:                                         ; preds = %for.cond
  %tmp90 = load <2 x i32>* %ccoord                ; <<2 x i32>> [#uses=1]
  %tmp91 = extractelement <2 x i32> %tmp90, i32 1 ; <i32> [#uses=1]
  %tmp92 = load <4 x i32> addrspace(1)** %offsets_in.addr ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp93 = load i32* %tx                          ; <i32> [#uses=1]
  %arrayidx94 = getelementptr <4 x i32> addrspace(1)* %tmp92, i32 %tmp93 ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp95 = load <4 x i32> addrspace(1)* %arrayidx94 ; <<4 x i32>> [#uses=1]
  %tmp96 = extractelement <4 x i32> %tmp95, i32 1 ; <i32> [#uses=1]
  %tmp97 = sub nsw i32 %tmp91, %tmp96             ; <i32> [#uses=1]
  %tmp98 = load <4 x i32> addrspace(1)** %offsets_in.addr ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp99 = load i32* %tx                          ; <i32> [#uses=1]
  %arrayidx100 = getelementptr <4 x i32> addrspace(1)* %tmp98, i32 %tmp99 ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp101 = load <4 x i32> addrspace(1)* %arrayidx100 ; <<4 x i32>> [#uses=1]
  %tmp102 = extractelement <4 x i32> %tmp101, i32 2 ; <i32> [#uses=1]
  %tmp103 = mul i32 %tmp97, %tmp102               ; <i32> [#uses=1]
  store i32 %tmp103, i32* %idx_pl
  %tmp104 = load i32* %idx_pl                     ; <i32> [#uses=1]
  %tmp105 = load <2 x i32>* %ccoord               ; <<2 x i32>> [#uses=1]
  %tmp106 = extractelement <2 x i32> %tmp105, i32 0 ; <i32> [#uses=1]
  %tmp107 = load <4 x i32> addrspace(1)** %offsets_in.addr ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp108 = load i32* %tx                         ; <i32> [#uses=1]
  %arrayidx109 = getelementptr <4 x i32> addrspace(1)* %tmp107, i32 %tmp108 ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp110 = load <4 x i32> addrspace(1)* %arrayidx109 ; <<4 x i32>> [#uses=1]
  %tmp111 = extractelement <4 x i32> %tmp110, i32 0 ; <i32> [#uses=1]
  %tmp112 = sub nsw i32 %tmp106, %tmp111          ; <i32> [#uses=1]
  %tmp113 = add nsw i32 %tmp104, %tmp112          ; <i32> [#uses=1]
  store i32 %tmp113, i32* %idx_pl
  %tmp114 = load i8 addrspace(1)** %pl_in.addr    ; <i8 addrspace(1)*> [#uses=1]
  %tmp115 = load i32* %idx_pl                     ; <i32> [#uses=1]
  %arrayidx116 = getelementptr i8 addrspace(1)* %tmp114, i32 %tmp115 ; <i8 addrspace(1)*> [#uses=1]
  %tmp117 = load i8 addrspace(1)* %arrayidx116    ; <i8> [#uses=1]
  %conv118 = uitofp i8 %tmp117 to float           ; <float> [#uses=1]
  store float %conv118, float* %pl_value
  %tmp119 = load float* %pl_value                 ; <float> [#uses=1]
  %cmp120 = fcmp ogt float %tmp119, 2.550000e+02  ; <i1> [#uses=1]
  br i1 %cmp120, label %if.then122, label %if.end121

for.inc:                                          ; preds = %if.end143
  %tmp152 = load i32* %tx                         ; <i32> [#uses=1]
  %tmp153 = add nsw i32 %tmp152, 1                ; <i32> [#uses=1]
  store i32 %tmp153, i32* %tx
  br label %for.cond

if.end121:                                        ; preds = %if.then122, %for.body
  %tmp123 = load float* %pl_value                 ; <float> [#uses=1]
  %tmp124 = fdiv float %tmp123, 2.550000e+02      ; <float> [#uses=1]
  %tmp125 = fsub float 1.000000e+00, %tmp124      ; <float> [#uses=1]
  store float %tmp125, float* %pl_value
  %tmp126 = load i32 addrspace(1)** %tx_pwr.addr  ; <i32 addrspace(1)*> [#uses=1]
  %tmp127 = load i32* %tx                         ; <i32> [#uses=1]
  %arrayidx128 = getelementptr i32 addrspace(1)* %tmp126, i32 %tmp127 ; <i32 addrspace(1)*> [#uses=1]
  %tmp129 = load i32 addrspace(1)* %arrayidx128   ; <i32> [#uses=1]
  %conv130 = sitofp i32 %tmp129 to float          ; <float> [#uses=1]
  %tmp131 = fdiv float %conv130, 1.000000e+03     ; <float> [#uses=1]
  %tmp132 = load float* %pl_value                 ; <float> [#uses=1]
  %tmp133 = fmul float %tmp131, %tmp132           ; <float> [#uses=1]
  %tmp134 = load float addrspace(1)** %qrm_in.addr ; <float addrspace(1)*> [#uses=1]
  %tmp135 = load i32* %idx_2d                     ; <i32> [#uses=1]
  %arrayidx136 = getelementptr float addrspace(1)* %tmp134, i32 %tmp135 ; <float addrspace(1)*> [#uses=1]
  %tmp137 = load float addrspace(1)* %arrayidx136 ; <float> [#uses=1]
  %tmp138 = fdiv float %tmp133, %tmp137           ; <float> [#uses=1]
  store float %tmp138, float* %pl_value
  %tmp139 = load <2 x float>* %max_signal         ; <<2 x float>> [#uses=1]
  %tmp140 = extractelement <2 x float> %tmp139, i32 1 ; <float> [#uses=1]
  %tmp141 = load float* %pl_value                 ; <float> [#uses=1]
  %cmp142 = fcmp olt float %tmp140, %tmp141       ; <i1> [#uses=1]
  br i1 %cmp142, label %if.then144, label %if.end143

if.then122:                                       ; preds = %for.body
  store float 2.550000e+02, float* %pl_value
  br label %if.end121

if.end143:                                        ; preds = %if.then144, %if.end121
  br label %for.inc

if.then144:                                       ; preds = %if.end121
  %tmp145 = load i32* %tx                         ; <i32> [#uses=1]
  %conv146 = sitofp i32 %tmp145 to float          ; <float> [#uses=1]
  %tmp147 = load <2 x float>* %max_signal         ; <<2 x float>> [#uses=1]
  %tmp148 = insertelement <2 x float> %tmp147, float %conv146, i32 0 ; <<2 x float>> [#uses=1]
  store <2 x float> %tmp148, <2 x float>* %max_signal
  %tmp149 = load float* %pl_value                 ; <float> [#uses=1]
  %tmp150 = load <2 x float>* %max_signal         ; <<2 x float>> [#uses=1]
  %tmp151 = insertelement <2 x float> %tmp150, float %tmp149, i32 1 ; <<2 x float>> [#uses=1]
  store <2 x float> %tmp151, <2 x float>* %max_signal
  br label %if.end143

for.cond180:                                      ; preds = %for.inc186, %if.else
  %tmp182 = load i32* %tx                         ; <i32> [#uses=1]
  %tmp183 = load i32* %ntx.addr                   ; <i32> [#uses=1]
  %cmp184 = icmp slt i32 %tmp182, %tmp183         ; <i1> [#uses=1]
  br i1 %cmp184, label %for.body185, label %for.exit181

for.exit181:                                      ; preds = %for.cond180
  %tmp254 = load <2 x float>* %min_signal         ; <<2 x float>> [#uses=1]
  %tmp255 = extractelement <2 x float> %tmp254, i32 0 ; <float> [#uses=1]
  %conv256 = fptosi float %tmp255 to i32          ; <i32> [#uses=1]
  store i32 %conv256, i32* %tx_id253
  store float 0xBF847AE140000000, float* %tx_new_pwr257
  %tmp258 = load float* %tx_new_pwr257            ; <float> [#uses=1]
  %call259 = call float @__pow_f32(float 1.000000e+01, float %tmp258) nounwind ; <float> [#uses=1]
  store float %call259, float* %tx_new_pwr257
  %tmp260 = load i16 addrspace(3)** %pblock.addr  ; <i16 addrspace(3)*> [#uses=1]
  %tmp261 = load i32* %idx_thread                 ; <i32> [#uses=1]
  %tmp262 = mul i32 2, %tmp261                    ; <i32> [#uses=1]
  %arrayidx263 = getelementptr i16 addrspace(3)* %tmp260, i32 %tmp262 ; <i16 addrspace(3)*> [#uses=1]
  %tmp264 = load i32* %tx_id253                   ; <i32> [#uses=1]
  %conv265 = trunc i32 %tmp264 to i16             ; <i16> [#uses=1]
  store i16 %conv265, i16 addrspace(3)* %arrayidx263
  %tmp266 = load i16 addrspace(3)** %pblock.addr  ; <i16 addrspace(3)*> [#uses=1]
  %tmp267 = load i32* %idx_thread                 ; <i32> [#uses=1]
  %tmp268 = mul i32 2, %tmp267                    ; <i32> [#uses=1]
  %tmp269 = add nsw i32 %tmp268, 1                ; <i32> [#uses=1]
  %arrayidx270 = getelementptr i16 addrspace(3)* %tmp266, i32 %tmp269 ; <i16 addrspace(3)*> [#uses=1]
  %tmp271 = load float* %tx_new_pwr257            ; <float> [#uses=1]
  %tmp272 = load i32 addrspace(1)** %tx_pwr.addr  ; <i32 addrspace(1)*> [#uses=1]
  %tmp273 = load i32* %tx_id253                   ; <i32> [#uses=1]
  %arrayidx274 = getelementptr i32 addrspace(1)* %tmp272, i32 %tmp273 ; <i32 addrspace(1)*> [#uses=1]
  %tmp275 = load i32 addrspace(1)* %arrayidx274   ; <i32> [#uses=1]
  %conv276 = sitofp i32 %tmp275 to float          ; <float> [#uses=1]
  %tmp277 = fmul float %tmp271, %conv276          ; <float> [#uses=1]
  %conv278 = fptoui float %tmp277 to i16          ; <i16> [#uses=1]
  store i16 %conv278, i16 addrspace(3)* %arrayidx270
  br label %if.end83

for.body185:                                      ; preds = %for.cond180
  %tmp188 = load <2 x i32>* %ccoord               ; <<2 x i32>> [#uses=1]
  %tmp189 = extractelement <2 x i32> %tmp188, i32 1 ; <i32> [#uses=1]
  %tmp190 = load <4 x i32> addrspace(1)** %offsets_in.addr ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp191 = load i32* %tx                         ; <i32> [#uses=1]
  %arrayidx192 = getelementptr <4 x i32> addrspace(1)* %tmp190, i32 %tmp191 ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp193 = load <4 x i32> addrspace(1)* %arrayidx192 ; <<4 x i32>> [#uses=1]
  %tmp194 = extractelement <4 x i32> %tmp193, i32 1 ; <i32> [#uses=1]
  %tmp195 = sub nsw i32 %tmp189, %tmp194          ; <i32> [#uses=1]
  %tmp196 = load <4 x i32> addrspace(1)** %offsets_in.addr ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp197 = load i32* %tx                         ; <i32> [#uses=1]
  %arrayidx198 = getelementptr <4 x i32> addrspace(1)* %tmp196, i32 %tmp197 ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp199 = load <4 x i32> addrspace(1)* %arrayidx198 ; <<4 x i32>> [#uses=1]
  %tmp200 = extractelement <4 x i32> %tmp199, i32 2 ; <i32> [#uses=1]
  %tmp201 = mul i32 %tmp195, %tmp200              ; <i32> [#uses=1]
  store i32 %tmp201, i32* %idx_pl187
  %tmp202 = load i32* %idx_pl187                  ; <i32> [#uses=1]
  ...
  store i32 %tmp211, i32* %idx_pl187
  %tmp213 = load i8 addrspace(1)** %pl_in.addr    ; <i8 addrspace(1)*> [#uses=1]
  %tmp214 = load i32* %idx_pl187                  ; <i32> [#uses=1]
...
for.inc186:                                       ; preds = %if.end242
  %tmp251 = load i32* %tx                         ; <i32> [#uses=1]
  %tmp252 = add nsw i32 %tmp251, 1                ; <i32> [#uses=1]
  store i32 %tmp252, i32* %tx
  br label %for.cond180

if.end220:                                        ; preds = %if.then221, %for.body185
  ...
  %tmp238 = load <2 x float>* %min_signal         ; <<2 x float>> [#uses=1]
  %tmp239 = extractelement <2 x float> %tmp238, i32 1 ; <float> [#uses=1]
  %tmp240 = load float* %pl_value212              ; <float> [#uses=1]
  %cmp241 = fcmp ogt float %tmp239, %tmp240       ; <i1> [#uses=1]
  br i1 %cmp241, label %if.then243, label %if.end242

if.then221:                                       ; preds = %for.body185
  store float 2.550000e+02, float* %pl_value212
  br label %if.end220

if.end242:                                        ; preds = %if.then243, %if.end220
  br label %for.inc186

if.then243:                                       ; preds = %if.end220
  %tmp244 = load i32* %tx                         ; <i32> [#uses=1]
  %conv245 = sitofp i32 %tmp244 to float          ; <float> [#uses=1]
  %tmp246 = load <2 x float>* %min_signal         ; <<2 x float>> [#uses=1]
  %tmp247 = insertelement <2 x float> %tmp246, float %conv245, i32 0 ; <<2 x float>> [#uses=1]
  store <2 x float> %tmp247, <2 x float>* %min_signal
  %tmp248 = load float* %pl_value212              ; <float> [#uses=1]
  %tmp249 = load <2 x float>* %min_signal         ; <<2 x float>> [#uses=1]
  %tmp250 = insertelement <2 x float> %tmp249, float %tmp248, i32 1 ; <<2 x float>> [#uses=1]
  store <2 x float> %tmp250, <2 x float>* %min_signal
  br label %if.end242
}
