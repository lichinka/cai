...
/**
 * A structure that enables subsequent calls of the same kernel
 * without repeating CPU-GPU transfers of unchanged data.
 */
typedef struct {
    ...
    clndrange_t kernel_range;       // the kernel range to be executed.
